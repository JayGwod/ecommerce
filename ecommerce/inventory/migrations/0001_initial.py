# Generated by Django 3.2.8 on 2021-12-05 14:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='format: reuqired, max-255', max_length=255, verbose_name='product name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='format: maximum price 999.99', max_digits=5, verbose_name='regular sotre price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='images/default.png', help_text='format:L required, default-default.png', upload_to='images/', verbose_name='product image')),
