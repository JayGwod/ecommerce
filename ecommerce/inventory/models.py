...
class Category(MPTTModel):
    ...
    slug = models.SlugField(
        ...
        help_text=_(
            "format: required, letters, number, underscore, or hyphens"
        ),
    )
...
class Product(models.Model):
    ...
    name = models.CharField(
        ...
        help_text=_("format: reuqired, max-255"),
    )
...
class ProductInventory(models.Model):
    ...
    store_price = models.DecimalField(
        ...
        null=False,
        blank=False,
        verbose_name=_("regular sotre price"),
        help_text=_("format: maximum price 999.99"),
        error_messages={
            "name": {
                "max_length": _("the price must be between 0 and 999.99.")
...
class Media(models.Model):
    ...
    image = models.ImageField(
        ...
        help_text=_("format:L required, default-default.png"),
    )
